...
\begin{enumerate}
	\item \textbf{Schematic Capture:} Components were placed and connected in the KiCad. Custom symbols were verified/created to match the footprints.
	\item \textbf{PCB Layout:} Components were arranged to minimize noise and loop area, specifically focusing on the critical loop of the boost converter.
...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|l|c|l|}
		...
		1           & J1                  & PinHeader\_1x04\_Vertical & 1            & Conn\_01x04          \\ \hline
...
\pagebreak
\subsection{Fabrication Preview}
To verify the final board design prior to manufacturing, the generated Gerber files were evaluated using a manufacturer's 3D viewer. Figure \ref{fig:jlpcb_preview} displays the rendered preview of the PCB via JLCPCB, confirming that the component footprints, drill holes, and board outline are correctly defined and ready for fabrication.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{jlpcb_preview.png}
    \caption{3D Board Preview via JLCPCB}
    \label{fig:jlpcb_preview}
\end{figure}
